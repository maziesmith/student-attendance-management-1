		 	...
		 	{	
		 		if($i == 0)
				{
		 		...
		 		else
		 		{
		 			...
		 			if($getData[2]=="male" || $getData[2] == "Male")
		 			{
		 				$getData[2]=1;
		 			}
		 			else
		 			...
		 			if(in_array($getData[7],$programname)){
		 				if(!in_array($getData[0],$rollno)){
									...
									if(strtolower($getData[9])=='yes'){
						 			...
						 			$sql = "INSERT INTO students VALUES ('','$getData[0]','$getData[1]','$getData[2]','$getData[3]','$getData[4]','$getData[5]','$getData[6]','$getData[7]','$id','$getData[8]','$cess','1','$schl')";
